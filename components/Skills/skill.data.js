export const FRONT_END = {
    ...
    REACT: {
        ...
        contents: [
            {
                content: "상단의 HTML, CSS, JS 항목에 적혀있는 작업은 Next.js 로도 할 수 있습니다."
            },
            {
                content: "Next.js, SWR, Emotion 로 개발을 해본적 있습니다.",
                types: ["personal", "company"]
            },
            {
    ...
    CANVAS: {
        ...
        contents: [
            ...
            {
                content: "API 를 통해 가져온 데이터를 chart.js 를 이용해 시각화를 해본적 있습니다.",
                types: ["company"]
            }
        ]
    },
    OPS: {
        ...
        contents: [
            ...
            {
                content: "AWS (Code Pipeline, Code Build, ECS, ECR, LB ... ) 으로 배포를 해본적 있습니다.",
                types: ["company"]
            },
        ]
    },
...
export const ALGORITHM = {
    ...
    ALGORITHM: {
        ...
        contents: [
            {
                content: "지금 작성하기에는 많아서, 추후 작성하겠습니다.",
            }
        ]
    }
};
